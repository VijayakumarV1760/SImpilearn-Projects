...
public class main {
    ...
    public static void main(String[] args)  {
        File folder = new File("C://Users/Hp/eclipse-workspace/test");
        ...
        while(true){
            ...
            System.out.println("********** The Appllication developted by Vijayakumar **********  \n");
            System.out.println("");
            System.out.println("");
            System.out.println("***** The following functions are :- *******   \n");
            System.out.println("1. To display the files in ascending order\n");
            System.out.println("2. Add, Delete and Search User Enabled Operations  \n");
            System.out.println("3. Terminate Program \n ");
            System.out.println("***** Enter the Input option *****  \n");
